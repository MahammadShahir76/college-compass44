    ...
    <div>
      <div id="meeting-container"></div>
        <div style={{ marginTop: '20px' }}>
          ...
          <button><a href='http://localhost:3000/CandidateReview'>End the meeting</a></button>
          <br></br>
          <a href="http://localhost:5173/editior/672e86634f7a2059467f7573" target="_blank" rel="noopener noreferrer">Open Editor</a>
